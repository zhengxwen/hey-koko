...
const UI = {
  en: {
    ...
    memory_empty: "Nothing remembered yet. Add a fact, or use /remember in chat.",
  ...
  zh: {
    ...
    label_memory: "长期记忆",
    memory_empty: "还没有记住任何事。在这里添加，或在聊天里用 /remember。",
  ...
  "zh-Hant": {
    ...
    label_memory: "長期記憶",
    memory_empty: "還沒有記住任何事。在這裡新增，或在聊天裡用 /remember。",
...
export function getLocalizedCommands() {
  return [
    ...
    { name: "/remember", desc: t("cmd_remember") },
