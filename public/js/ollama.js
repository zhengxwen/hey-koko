...
function comfyModelComponents(name) {
  ...
  // Video
  if (/animate/.test(n)) return "Wan Animate (pose transfer) · UNETLoader + lightx2v + relight LoRA · ModelSamplingSD3 · LoadVideo→DWPose(pose+face) · WanAnimateToVideo · segment length adapts to resolution (≤640: 241f · 720p: 121f · 1080p: 65f) — a longer source is generated in segments (video_frame_offset) and merged";
